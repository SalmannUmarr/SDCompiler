...
public class JFlexMain {
    public static void main(String[] args) {
        ...
        finalLog.append("JFlex SCANNER TEST RESULTS\n").append("=".repeat(30)).append("\n");
        ...
        for (String fileName : testFiles) {
            try {
                ...
                JFlexScanner scanner = new JFlexScanner(new StringReader(content), stats, err);
        ...
        System.out.println("\nAll tests complete. Results saved to TestResults_JFlex.txt");

        try {
            Files.writeString(Paths.get("TestResults_JFlex.txt"), finalLog.toString());
        } catch (Exception e) {
